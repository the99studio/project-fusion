...
**Generated:** 17/08/2025 18:28:59 UTC−4

**UTC:** 2025-08-17T22:28:59.203Z
...
<body>
    <div class="header">
        ...
        <p><strong>Generated:</strong> 17/08/2025 18:21:26 UTC−4</p>
        <p><strong>UTC:</strong> 2025-08-17T22:21:26.710Z</p>
    ...
    <div class="toc">
        ...
        <ul>
            ...
            <li><a href="#src-fusion-v2-ts">src/fusion-v2.ts</a></li>
...
runExamples().catch(console.error);</code></pre>
    ...
    <div class="file-section" id="project-fusioned-html">
        <div class="file-title">
            <h2>📄 project-fusioned.html</h2>
        </div>
...
export function projectFusion(): ProjectFusionBuilder {
    ...
    <div class="file-section" id="src-fusion-v2-ts">
        <div class="file-title">
            <h2>📄 src/fusion-v2.ts</h2>
        </div>
        <pre><code class="typescript">// SPDX-License-Identifier: MIT
// Copyright (c) 2025 the99studio
/**
...
describe(&#39;utils&#39;, () =&gt; {
  ...
  describe(&#39;loadConfig&#39;, () =&gt; {
    ...
    <div class="file-section" id="todo-md">
        ...
        <pre><code class="markdown"># TODO Project Fusion
